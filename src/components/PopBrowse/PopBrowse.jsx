...
export default function PopBrowse({ task, onClose, onUpdate, onDelete }) {
  ...
  const handleSave = () => {
    onUpdate({ ...task, desc, status, date: date || "—" });
    setEditMode(false);
  };
    ...
    <div className="overlay" onClick={onClose}>
      <div className="pop pop-browse" onClick={e => e.stopPropagation()}>
        ...
        <div className="pop-browse__top-block">
          ...
          <div className={`categories__theme ${cat.colorClass} _active-category theme-top`}>
        ...
        {!editMode ? (
          <div className="pop-browse__btn-browse">
            <div className="btn-group">
              <button className="_btn-bor" onClick={() => setEditMode(true)}>Редактировать задачу</button>
              <button className="_btn-bor" onClick={handleDelete}>Удалить задачу</button>
            </div>
          ...
          <div className="pop-browse__btn-browse">
            <div className="btn-group">
              <button className="_btn-bg"  onClick={handleSave}>Сохранить</button>
              <button className="_btn-bor" onClick={() => setEditMode(false)}>Отменить</button>
              <button className="_btn-bor" onClick={handleDelete}>Удалить задачу</button>
            </div>
            <button className="_btn-bg" onClick={onClose}>Закрыть</button>
          </div>
